  ...
  return (
    <div className="company">
        <form action="">
          ...
          <select name="company" id="" value={filter.company} onChange={FilterFunction} className='w-full py-1 px-2 outline-none border border-gray-400 rounded-md cursor-pointer'>
            {
